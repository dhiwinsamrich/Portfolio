  ...
  if (!mounted) {
    return (
      <div className="relative inline-block scale-75 sm:scale-100">
        <div className="relative flex h-[36px] w-[60px] items-center rounded-full bg-gray-200 p-1" />
      </div>
    );
  }
  ...
  return (
    <div className="relative inline-block scale-75 sm:scale-100">
      ...
      <motion.button
        ...
        className="relative flex h-[36px] w-[60px] items-center rounded-full p-[4px] transition-all duration-300 focus:outline-none"
        style={{
          background: isDark
          ...
          boxShadow: isDark
            ? `
              ...
              inset -3px -3px 8px rgba(100, 116, 139, 0.2),
              inset 0 1px 2px rgba(0, 0, 0, 1),
              inset 0 -1px 2px rgba(71, 85, 105, 0.4),
            ...
            : `
              ...
              inset 3px 3px 8px rgba(100, 116, 139, 0.3),
              inset -3px -3px 8px rgba(255, 255, 255, 0.9),
              inset 0 1px 2px rgba(148, 163, 184, 0.4),
              inset 0 -1px 2px rgba(255, 255, 255, 1),
              inset 0 0 10px rgba(203, 213, 225, 0.3),
      ...
      >
        ...
        <motion.div
          className="relative z-10 flex h-[28px] w-[28px] items-center justify-center rounded-full overflow-hidden"
          style={{
            background: isDark
